...
const ProfileCard = ({ name, primaryGenre, genres, subGenres, age, country, profilePic, handleNextMatch, handlePreviousMatch }) => {
...
<Box
 ...
 <Image src={profilePic} alt={`${name}'s picture`} boxSize="150px" borderRadius="10%"/>       
      </Flex>
